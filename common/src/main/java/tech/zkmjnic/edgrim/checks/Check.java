...
public class Check extends GrimProcessor implements AbstractCheck {
    ...
    public final void updatePermissions() {
        ...
        exemptPermission = player.platformPlayer.hasPermission("edgrim.exempt." + id);
        noSetbackPermission = player.platformPlayer.hasPermission("edgrim.nosetback." + id);
        noModifyPacketPermission = player.platformPlayer.hasPermission("edgrim.nomodifypacket." + id);
    }
