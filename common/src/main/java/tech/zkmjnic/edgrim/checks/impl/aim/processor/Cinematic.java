...
import tech.zkmjnic.edgrim.utils.graphing.GraphUtil;
...
public final class Cinematic extends Check implements RotationCheck {
    ...
    private void updateCinematic2(RotationUpdate rotationUpdate, boolean cinematic2Flag) {
        boolean allowed = EdGrimAPI.INSTANCE.getConfigManager().getConfig().getBooleanElse("function.allowed-cinematic", false);
