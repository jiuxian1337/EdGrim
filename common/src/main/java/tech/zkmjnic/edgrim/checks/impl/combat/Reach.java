// This file was designed and is an original check for EdGrim
...
public class Reach extends Check implements PacketCheck {
    ...
    public Reach(EdGrimPlayer player) {
        super(player);
    }
    ...
    public void onPacketReceive(final PacketReceiveEvent event) {
        if (!player.disableGrim && event.getPacketType() == PacketType.Play.Client.INTERACT_ENTITY) {
            ...
            // Dead entities cause false flags (https://github.com/edgrimAnticheat/edgrim/issues/546)
