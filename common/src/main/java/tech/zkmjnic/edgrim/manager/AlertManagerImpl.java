...
public final class AlertManagerImpl implements AlertManager, ConfigReloadable, StartableInitable {
    ...
    @Override
    public void start() {
        platformServer = EdGrimAPI.INSTANCE.getPlatformServer();
    ...
    private PlatformPlayer requirePlatformPlayerFromUser(@NonNull GrimUser user) {
        ...
        PlatformPlayer platformPlayer = EdGrimPlayer.platformPlayer;
    ...
    public boolean hasBrandsEnabled(@NonNull GrimUser player) {
        ...
        if (EdGrimPlayer.platformPlayer == null) return false;

        return hasBrandsEnabled(EdGrimPlayer.platformPlayer);
    }
