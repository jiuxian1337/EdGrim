...
public class JavaVersion implements StartableInitable {
    ...
    public void start() {
        ...
        if (version < 17) {
            ...
            LogUtil.warn("EdGrim will no longer support this version of Java in a future release.");
            LogUtil.warn("See https://github.com/edgrimAnticheat/edgrim/wiki/Updating-to-Java-17 for more information.");
        }
    }
}
