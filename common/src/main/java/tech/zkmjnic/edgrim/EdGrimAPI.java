...
@Getter
public final class EdGrimAPI {
    public static final EdGrimAPI INSTANCE = new EdGrimAPI();
    ...
    private final EdGrimExternalAPI externalAPI;
    ...
    private EdGrimAPI() {
        ...
        this.externalAPI = new EdGrimExternalAPI(this);
    }
    ...
    private void checkInitialized() {
        if (!initialized) {
            throw new IllegalStateException("EdGrimAPI has not been initialized!");
        }
    }
