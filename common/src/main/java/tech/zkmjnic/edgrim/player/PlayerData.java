...
import tech.zkmjnic.edgrim.predictionengine.PointThreeEstimator;
...
public class PlayerData implements GrimUser {
    ...
    public void onPacketCancel() {
        if (spamThreshold != -1 && cancelledPackets.incrementAndGet() > spamThreshold) {
            ...
            disconnect(MessageUtil.miniMessage(MessageUtil.replacePlaceholders(this, EdGrimAPI.INSTANCE.getConfigManager().getDisconnectClosed())));
    ...
    public void timedOut() {
        disconnect(MessageUtil.miniMessage(MessageUtil.replacePlaceholders(this, EdGrimAPI.INSTANCE.getConfigManager().getDisconnectTimeout())));
    }
    ...
    public void disconnect(Component reason) {
        ...
        if (platformPlayer != null) {
            EdGrimAPI.INSTANCE.getScheduler().getEntityScheduler().execute(platformPlayer, EdGrimAPI.INSTANCE.getGrimPlugin(),
    ...
    public void pollData() {
        ...
        if (!EdGrimAPI.INSTANCE.getPlayerDataManager().shouldCheck(user)) {
            EdGrimAPI.INSTANCE.getPlayerDataManager().remove(user);
        }
    ...
    public void updatePermissions() {
        ...
        try {
            EdGrimAPI.INSTANCE.getScheduler().getEntityScheduler().execute(platformPlayer, EdGrimAPI.INSTANCE.getGrimPlugin(), () -> {
                this.noModifyPacketPermission = platformPlayer.hasPermission("edgrim.nomodifypacket");
                this.noSetbackPermission = platformPlayer.hasPermission("edgrim.nosetback");
