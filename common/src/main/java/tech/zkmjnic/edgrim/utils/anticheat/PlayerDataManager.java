...
public class PlayerDataManager {
    ...
    public void onDisconnect(User user) {
        ...
        EdGrimAPI.INSTANCE.getAlertManager().handlePlayerQuit(
                EdGrimAPI.INSTANCE.getPlatformPlayerFactory().getFromUUID(uuid)
        );

        EdGrimAPI.INSTANCE.getSpectateManager().onQuit(uuid);
