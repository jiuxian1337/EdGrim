...
public class BlockBreakSpeed {
    // temporary hardcode to workaround PE bug https://github.com/retrooper/packetevents/issues/1217; see https://github.com/edgrimAnticheat/edgrim/issues/2117
    ...
    public static double getBlockDamage(PlayerData player, WrappedBlockState block) {
        ...
        boolean canHarvest = !block.getType().isRequiresCorrectTool() || isCorrectToolForDrop
                // temporary hardcode to workaround PE bug https://github.com/retrooper/packetevents/issues/1217; see https://github.com/edgrimAnticheat/edgrim/issues/2091
