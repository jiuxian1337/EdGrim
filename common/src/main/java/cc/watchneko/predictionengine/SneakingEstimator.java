...
/**
 * 1.14 players leave sneaking two ticks after they jump off the ground.
 * <p>
 * 1.8 players leave sneaking the tick after they jump off the ground.
 * <p>
 ...
 * <p>
 * 1.14 players have sneaking slowdown delayed by 2 (!)(?) ticks, which hurts uncertainty badly.
 * 1.8 players have sneaking slowdown applied immediately.
 * <p>
 * Now 1.14 players having this delay is not a big deal, although it makes god bridging painfully annoying.
 * But without the idle packet, this kills predictions. Thanks for this stupidity, Mojang.
 * <p>
 * So this is a value patch like 0.03 because it can be "close enough" that it is better to not skip ticks.
 */
