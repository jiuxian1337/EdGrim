package cc.watchneko.predictionengine;

import ac.grim.grimac.api.config.ConfigManager;
import cc.watchneko.checks.Check;
import cc.watchneko.checks.impl.prediction.Phase;
import cc.watchneko.checks.impl.vehicle.VehicleC;
import cc.watchneko.checks.type.PositionCheck;
import cc.watchneko.manager.SetbackTeleportUtil;
import cc.watchneko.player.PlayerData;
import cc.watchneko.predictionengine.movementtick.*;
import cc.watchneko.predictionengine.predictions.PredictionEngineNormal;
import cc.watchneko.predictionengine.predictions.rideable.PredictionEngineBoat;
...
import cc.watchneko.utils.data.packetentity.*;
