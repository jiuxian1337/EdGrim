package cc.watchneko.manager.violationdatabase.sqlite;

import ac.grim.grimac.api.plugin.GrimPlugin;
import cc.watchneko.WatchNekoAPI;
import cc.watchneko.manager.violationdatabase.*;
...
public class SQLiteViolationDatabase implements ViolationDatabase {
    ...
    public synchronized void logAlert(PlayerData player, String grimVersion, String verbose, String checkName, int vls) {
        try (
            ...
            String serverName = WatchNekoAPI.INSTANCE.getConfigManager().getConfig().getStringElse("history.server-name", "Prison");
