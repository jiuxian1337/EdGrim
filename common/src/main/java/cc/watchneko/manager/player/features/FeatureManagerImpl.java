...
public class FeatureManagerImpl implements FeatureManager, ConfigReloadObserver {
    ...
    @Override
    public void reload() {
        onReload(WatchNekoAPI.INSTANCE.getExternalAPI().getConfigManager());
    }
