...
public class LogUtil {
    ...
    public Logger getLogger() {
        return WatchNekoAPI.INSTANCE.getGrimPlugin().getLogger();
    }

    public void console(final String info) {
        WatchNekoAPI.INSTANCE.getPlatformServer().getConsoleSender().sendMessage(MessageUtil.translateAlternateColorCodes('&', info));
    }

    public void console(final Component info) {
        WatchNekoAPI.INSTANCE.getPlatformServer().getConsoleSender().sendMessage(info);
    }
