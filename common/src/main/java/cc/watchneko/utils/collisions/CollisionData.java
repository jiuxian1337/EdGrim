package cc.watchneko.utils.collisions;

import cc.watchneko.player.PlayerData;
import cc.watchneko.predictionengine.movementtick.MovementTickerStrider;
import cc.watchneko.utils.collisions.blocks.*;
import cc.watchneko.utils.collisions.blocks.connecting.DynamicCollisionFence;
import cc.watchneko.utils.collisions.blocks.connecting.DynamicCollisionPane;
import cc.watchneko.utils.collisions.blocks.connecting.DynamicCollisionWall;
import cc.watchneko.utils.collisions.datatypes.*;
import cc.watchneko.utils.data.packetentity.PacketEntityStrider;
...
public enum CollisionData implements CollisionFactory {
    ...
    ANVIL((player, version, data, x, y, z) -> {
        ...
        // The base is 0.75x0.75, and its floor is 0.25b high.
        // The top is 1x0.625, and its ceiling is 0.375b low.
        if (version.isNewerThanOrEquals(ClientVersion.V_1_13)) {
