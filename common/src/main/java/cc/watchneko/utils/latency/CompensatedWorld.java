package cc.watchneko.utils.latency;

import cc.watchneko.WatchNekoAPI;
import cc.watchneko.player.PlayerData;
import cc.watchneko.utils.change.BlockModification;
import cc.watchneko.utils.chunks.Column;
import cc.watchneko.utils.collisions.CollisionData;
import cc.watchneko.utils.collisions.datatypes.SimpleCollisionBox;
import cc.watchneko.utils.data.BlockPrediction;
import cc.watchneko.utils.data.Pair;
import cc.watchneko.utils.data.PistonData;
import cc.watchneko.utils.data.ShulkerData;
import cc.watchneko.utils.data.packetentity.PacketEntity;
import cc.watchneko.utils.data.packetentity.PacketEntityShulker;
        ...
        if (getBlock(vector3i).getGlobalId() != originalBlockId) {
            player.blockHistory.add(
                    new BlockModification(
                            ...
                            vector3i,
                            WatchNekoAPI.INSTANCE.getTickManager().currentTick,
