...
import cc.watchneko.checks.impl.badpackets.BadPacketsE;
import cc.watchneko.checks.impl.badpackets.BadPacketsF;
import cc.watchneko.checks.impl.badpackets.BadPacketsG;
import cc.watchneko.checks.impl.badpackets.BadPacketsH;
import cc.watchneko.checks.impl.elytra.ElytraC;
...
public class PacketPlayerRespawn extends PacketListenerAbstract {
    ...
    public void onPacketSend(PacketSendEvent event) {
        if (event.getPacketType() == PacketType.Play.Server.UPDATE_HEALTH) {
            ...
            PlayerData player = WatchNekoAPI.INSTANCE.getPlayerDataManager().getPlayer(event.getUser());
