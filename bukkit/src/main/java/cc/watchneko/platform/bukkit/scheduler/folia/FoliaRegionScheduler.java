...
import cc.watchneko.platform.api.scheduler.RegionScheduler;
...
import cc.watchneko.platform.bukkit.world.BukkitPlatformWorld;
...
public class FoliaRegionScheduler implements RegionScheduler {
    ...
    public void execute(@NotNull GrimPlugin plugin, @NotNull PlatformWorld world, int chunkX, int chunkZ, @NotNull Runnable task) {
        regionScheduler.execute(WatchNekoBukkitLoaderPlugin.LOADER, ((BukkitPlatformWorld) world).bukkitWorld(), chunkX, chunkZ, task);
    }
