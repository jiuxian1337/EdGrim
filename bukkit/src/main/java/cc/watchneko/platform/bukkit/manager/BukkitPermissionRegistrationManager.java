...
import cc.watchneko.platform.api.manager.PermissionRegistrationManager;
...
public class BukkitPermissionRegistrationManager implements PermissionRegistrationManager {
     ...
     * like "watchneko.exempt.checkname") that are generated at runtime. Most other static permissions
     * (e.g., "watchneko.exempt", "watchneko.alerts.enable-on-join") are registered with their defaults
     ...
     *
     * @param name         The permission node to register (e.g., "watchneko.exempt.checkname").
