...
public class PlaceholderAPIExpansion extends PlaceholderExpansion {
    ...
    public @NotNull String getAuthor() {
        return String.join(", ", EdGrimAPI.INSTANCE.getGrimPlugin().getDescription().getAuthors());
    }

    @Override
    public @NotNull String getVersion() {
        return EdGrimAPI.INSTANCE.getExternalAPI().getGrimVersion();
    }
    ...
    public @NotNull List<String> getPlaceholders() {
        Set<String> staticReplacements = EdGrimAPI.INSTANCE.getExternalAPI().getStaticReplacements().keySet();
        Set<String> variableReplacements = EdGrimAPI.INSTANCE.getExternalAPI().getVariableReplacements().keySet();
    ...
    public String onRequest(OfflinePlayer offlinePlayer, @NotNull String params) {
        ...
        if (offlinePlayer instanceof Player player) {
            ...
            for (Map.Entry<String, Function<GrimUser, String>> entry : EdGrimAPI.INSTANCE.getExternalAPI().getVariableReplacements().entrySet()) {
                ...
                if (params.equalsIgnoreCase(key)) {
                    return entry.getValue().apply(EdGrimPlayer);
                }
            }
        }
